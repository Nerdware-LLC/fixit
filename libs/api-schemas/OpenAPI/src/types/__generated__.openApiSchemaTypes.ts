 ...
 *
 * This file was auto-generated using schema version: `2.2.0`
 */
...
export interface components {
    schemas: {
        UserRegistrationParams: components["schemas"]["LoginCredentials"] & components["schemas"]["ExpoPushTokenField"] & {
            handle: components["schemas"]["handle"];
            email: components["schemas"]["email"];
            phone?: components["schemas"]["phone"];
        };
        LoginParams: components["schemas"]["LoginCredentials"] & components["schemas"]["ExpoPushTokenField"];
    ...
    requestBodies: {
        ...
        RefreshAuthTokenRequest: {
            content: {
                "application/json": components["schemas"]["ExpoPushTokenField"];
            };
        };
        StripeLinkRequest: {
            content: {
