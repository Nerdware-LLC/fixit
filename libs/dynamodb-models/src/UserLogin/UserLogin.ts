...
import { passwordHasher } from "@fixit/auth";
...
export class UserLogin {
   ...
   * @param params.password - The password to create a UserLoginLocal object.
   * @param params.googleID - The Google ID to create a UserLoginGoogleOAuth object.
